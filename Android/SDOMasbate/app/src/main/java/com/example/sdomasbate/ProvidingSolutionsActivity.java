...
public class ProvidingSolutionsActivity extends AppCompatActivity implements SmileRating.OnSmileySelectionListener, SmileRating.OnRatingSelectedListener {

    public static final String EXTRA_RATING_PROVIDING_SOLUTIONS = "providing_solutions";
    public static final String EXTRA_REMARKS_PROVIDING_SOLUTIONS = "providing_solutions_remarks";
    ...
    String text_rating_respect, text_remarks_respect, text_rating_PD, text_remarks_PD, text_rating_MV, text_remarks_MV, text_rating_RQ, text_remarks_RQ,
            text_rating_smiling, text_remarks_smiling;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_providing_solutions);
...
//        purpose.setText(text_purpose);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(rating == "None"){
                    ...
                    Intent intent = new Intent(ProvidingSolutionsActivity.this, WastingNoTimeActivity.class );
                    ...
                    intent.putExtra(EXTRA_RATING_PROVIDING_SOLUTIONS, rating);
                    intent.putExtra(EXTRA_REMARKS_PROVIDING_SOLUTIONS, suggestionInput);
    ...
    public void onBackPressed() {
        ...
        soundPool.play(introSound, 1, 1, 0, 0, 1);
        Intent intent = new Intent(ProvidingSolutionsActivity.this, SmilingActivity.class );
        intent.putExtra(DivisionActivity.EXTRA_CHOOSE, choose);
        intent.putExtra(SurveyActivity.EXTRA_NAME, text_name);
        intent.putExtra(SurveyActivity.EXTRA_POSITION, text_position);
        intent.putExtra(SurveyActivity.EXTRA_PURPOSE, text_purpose);
...
//                    public void onClick(DialogInterface dialog, int which) {
//                        soundPool.play(introSound, 1, 1, 0, 0, 1);
//                        Intent intent = new Intent(ProvidingSolutionsActivity.this, DashboardActivity.class);
//                        startActivity(intent);
//                    }
//                })
//

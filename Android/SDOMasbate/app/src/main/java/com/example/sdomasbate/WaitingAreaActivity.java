...
public class WaitingAreaActivity extends AppCompatActivity implements SmileRating.OnSmileySelectionListener, SmileRating.OnRatingSelectedListener {

    public static final String EXTRA_RATING_WAITING_AREA = "waiting_area";
    public static final String EXTRA_REMARKS_WAITING_AREA = "waiting_area_remarks";
   ...
   // public TextView name, position, purpose;
    ...
    String text_rating_respect, text_remarks_respect, text_rating_PD, text_remarks_PD, text_rating_MV, text_remarks_MV, text_rating_RQ, text_remarks_RQ,
            ...
            text_rating_comfort_rooms, text_remarks_comfort_rooms, text_rating_guards, text_remarks_guards;
    String rating = "None";
...
//        purpose.setText(text_purpose);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(rating == "None"){
                    ...
                    Intent intent = new Intent(WaitingAreaActivity.this, OfficesCleanActivity.class );
                    ...
                    intent.putExtra(EXTRA_RATING_WAITING_AREA, rating);
                    intent.putExtra(EXTRA_REMARKS_WAITING_AREA, suggestionInput);
    ...
    public void onBackPressed() {
        ...
        soundPool.play(introSound, 1, 1, 0, 0, 1);
        Intent intent = new Intent(WaitingAreaActivity.this, GuardsActivity.class );
        intent.putExtra(DivisionActivity.EXTRA_CHOOSE, choose);
        intent.putExtra(SurveyActivity.EXTRA_NAME, text_name);
        intent.putExtra(SurveyActivity.EXTRA_POSITION, text_position);
        intent.putExtra(SurveyActivity.EXTRA_PURPOSE, text_purpose);
...
//                    public void onClick(DialogInterface dialog, int which) {
//                        soundPool.play(introSound, 1, 1, 0, 0, 1);
//                        Intent intent = new Intent(WaitingAreaActivity.this, DashboardActivity.class);
//                        startActivity(intent);
//                    }
//                })
//

...
public class RespectActivity extends AppCompatActivity implements SmileRating.OnSmileySelectionListener, SmileRating.OnRatingSelectedListener {

//    public static final String EXTRA_NAME_2 = "name2";
//    public static final String EXTRA_POSITION_2 = "position2";
//    public static final String EXTRA_PURPOSE_2 = "purpose2";

    public static final String EXTRA_RATING_RESPECT = "respect";
    public static final String EXTRA_REMARKS_RESPECT = "respect_remarks";
...
//        purpose.setText(text_purpose);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(rating == "None"){
                    ...
                    Intent intent = new Intent(RespectActivity.this, ProperlyDressedActivity.class);
                    ...
                    intent.putExtra(EXTRA_RATING_RESPECT, rating);
                    intent.putExtra(EXTRA_REMARKS_RESPECT, suggestionInput);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(RespectActivity.this, SurveyActivity.class);
        intent.putExtra(DivisionActivity.EXTRA_CHOOSE, choose);
...
//                    public void onClick(DialogInterface dialog, int which) {
//                        soundPool.play(introSound, 1, 1, 0, 0, 1);
//                        Intent intent = new Intent(RespectActivity.this, DashboardActivity.class);
//                        startActivity(intent);
//                    }
//                })
//

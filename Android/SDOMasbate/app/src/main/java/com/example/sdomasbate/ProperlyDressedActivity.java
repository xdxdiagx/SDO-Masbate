...
public class ProperlyDressedActivity extends AppCompatActivity implements SmileRating.OnSmileySelectionListener, SmileRating.OnRatingSelectedListener {

    public static final String EXTRA_RATING_PROPERLY_DRESSED = "properly_dressed";
    public static final String EXTRA_REMARKS_PROPERLY_DRESSED = "properly_dressed_remarks";
   ...
   // public TextView name, position, purpose;
    ...
    String text_rating_respect, text_remarks_respect;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_properly_dressed);
...
//        purpose.setText(text_purpose);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(rating == "None"){
                    ...
                    Intent intent = new Intent(ProperlyDressedActivity.this, MotivatedVoiceActivity.class );
                    ...
                    intent.putExtra(EXTRA_RATING_PROPERLY_DRESSED, rating);
                    intent.putExtra(EXTRA_REMARKS_PROPERLY_DRESSED, suggestionInput);
    ...
    public void onBackPressed() {
        ...
        soundPool.play(introSound, 1, 1, 0, 0, 1);
        Intent intent = new Intent(ProperlyDressedActivity.this, RespectActivity.class);
        intent.putExtra(DivisionActivity.EXTRA_CHOOSE, choose);
        intent.putExtra(SurveyActivity.EXTRA_NAME, text_name);
        intent.putExtra(SurveyActivity.EXTRA_POSITION, text_position);
        intent.putExtra(SurveyActivity.EXTRA_PURPOSE, text_purpose);
...
//                    public void onClick(DialogInterface dialog, int which) {
//                        soundPool.play(introSound, 1, 1, 0, 0, 1);
//                        Intent intent = new Intent(ProperlyDressedActivity.this, DashboardActivity.class);
//                        startActivity(intent);
//                    }
//                })
//

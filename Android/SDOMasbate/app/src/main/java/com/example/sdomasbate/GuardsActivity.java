...
public class GuardsActivity extends AppCompatActivity implements SmileRating.OnSmileySelectionListener, SmileRating.OnRatingSelectedListener {

    public static final String EXTRA_RATING_GUARDS = "guards";
    public static final String EXTRA_REMARKS_GUARDS = "guards_remarks";
    ...
    String text_rating_respect, text_remarks_respect, text_rating_PD, text_remarks_PD, text_rating_MV, text_remarks_MV, text_rating_RQ, text_remarks_RQ,
            ...
            text_rating_comfort_rooms, text_remarks_comfort_rooms;
    String rating = "None";
...
//        purpose.setText(text_purpose);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(rating == "None"){
                    ...
                    Intent intent = new Intent(GuardsActivity.this, WaitingAreaActivity.class );
                    ...
                    intent.putExtra(EXTRA_RATING_GUARDS, rating);
                    intent.putExtra(EXTRA_REMARKS_GUARDS, suggestionInput);
    ...
    public void onBackPressed() {
        ...
        soundPool.play(introSound, 1, 1, 0, 0, 1);
        Intent intent = new Intent(GuardsActivity.this, ComfortRoomsActivity.class );
        intent.putExtra(DivisionActivity.EXTRA_CHOOSE, choose);
        intent.putExtra(SurveyActivity.EXTRA_NAME, text_name);
        intent.putExtra(SurveyActivity.EXTRA_POSITION, text_position);
        intent.putExtra(SurveyActivity.EXTRA_PURPOSE, text_purpose);
...
//                    public void onClick(DialogInterface dialog, int which) {
//                        soundPool.play(introSound, 1, 1, 0, 0, 1);
//                        Intent intent = new Intent(GuardsActivity.this, DashboardActivity.class);
//                        startActivity(intent);
//                    }
//                })
//

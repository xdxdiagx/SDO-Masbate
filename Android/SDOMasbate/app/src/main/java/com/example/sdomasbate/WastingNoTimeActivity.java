...
public class WastingNoTimeActivity extends AppCompatActivity implements SmileRating.OnSmileySelectionListener, SmileRating.OnRatingSelectedListener {

    public static final String EXTRA_RATING_WASTING_NO_TIME = "wasting_no_time";
    public static final String EXTRA_REMARKS_WASTING_NO_TIME = "wasting_no_time_remarks";
    ...
    String text_rating_respect, text_remarks_respect, text_rating_PD, text_remarks_PD, text_rating_MV, text_remarks_MV, text_rating_RQ, text_remarks_RQ,
            text_rating_smiling, text_remarks_smiling, text_rating_PS, text_remarks_PS;
    String rating = "None";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wasting_no_time);
...
//        purpose.setText(text_purpose);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(rating == "None"){
                    ...
                    Intent intent = new Intent(WastingNoTimeActivity.this, ComfortRoomsActivity.class );
                    ...
                    intent.putExtra(EXTRA_RATING_WASTING_NO_TIME, rating);
                    intent.putExtra(EXTRA_REMARKS_WASTING_NO_TIME, suggestionInput);
    ...
    public void onBackPressed() {
        ...
        soundPool.play(introSound, 1, 1, 0, 0, 1);
        Intent intent = new Intent(WastingNoTimeActivity.this, ProvidingSolutionsActivity.class );
        intent.putExtra(DivisionActivity.EXTRA_CHOOSE, choose);
        intent.putExtra(SurveyActivity.EXTRA_NAME, text_name);
        intent.putExtra(SurveyActivity.EXTRA_POSITION, text_position);
        intent.putExtra(SurveyActivity.EXTRA_PURPOSE, text_purpose);
...
//                    public void onClick(DialogInterface dialog, int which) {
//                        soundPool.play(introSound, 1, 1, 0, 0, 1);
//                        Intent intent = new Intent(WastingNoTimeActivity.this, DashboardActivity.class);
//                        startActivity(intent);
//                    }
//                })
//

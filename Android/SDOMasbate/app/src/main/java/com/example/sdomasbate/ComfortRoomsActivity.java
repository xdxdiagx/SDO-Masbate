...
public class ComfortRoomsActivity extends AppCompatActivity implements SmileRating.OnSmileySelectionListener, SmileRating.OnRatingSelectedListener {

    public static final String EXTRA_RATING_COMFORT_ROOMS = "comfort_rooms";
    public static final String EXTRA_REMARKS_COMFORT_ROOMS = "comfort_rooms_remarks";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comfort_rooms);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(rating == "None"){
                    ...
                    Intent intent = new Intent(ComfortRoomsActivity.this, GuardsActivity.class );
                    ...
                    intent.putExtra(EXTRA_RATING_COMFORT_ROOMS, rating);
                    intent.putExtra(EXTRA_REMARKS_COMFORT_ROOMS, suggestionInput);
    ...
    public void onBackPressed() {
        ...
        soundPool.play(introSound, 1, 1, 0, 0, 1);
        Intent intent = new Intent(ComfortRoomsActivity.this, WastingNoTimeActivity.class );
        intent.putExtra(DivisionActivity.EXTRA_CHOOSE, choose);
        intent.putExtra(SurveyActivity.EXTRA_NAME, text_name);
        intent.putExtra(SurveyActivity.EXTRA_POSITION, text_position);
        intent.putExtra(SurveyActivity.EXTRA_PURPOSE, text_purpose);
...
//                    public void onClick(DialogInterface dialog, int which) {
//                        soundPool.play(introSound, 1, 1, 0, 0, 1);
//                        Intent intent = new Intent(ComfortRoomsActivity.this, DashboardActivity.class);
//                        startActivity(intent);
//                    }
//                })
//

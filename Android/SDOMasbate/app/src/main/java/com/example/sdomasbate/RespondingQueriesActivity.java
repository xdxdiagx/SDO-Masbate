...
public class RespondingQueriesActivity extends AppCompatActivity implements SmileRating.OnSmileySelectionListener, SmileRating.OnRatingSelectedListener {

    public static final String EXTRA_RATING_RESPONDING_TO_QUERIES = "responding_to_queries";
    public static final String EXTRA_REMARKS_RESPONDING_TO_QUERIES = "responding_to_queries_remarks";
    ...
    String text_rating_respect, text_remarks_respect, text_rating_PD, text_remarks_PD, text_rating_MV, text_remarks_MV;
    String rating = "None";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_responding_queries);
...
//        purpose.setText(text_purpose);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(rating == "None"){
                    ...
                    Intent intent = new Intent(RespondingQueriesActivity.this, SmilingActivity.class );
                    ...
                    intent.putExtra(EXTRA_RATING_RESPONDING_TO_QUERIES, rating);
                    intent.putExtra(EXTRA_REMARKS_RESPONDING_TO_QUERIES, suggestionInput);
    ...
    public void onBackPressed() {
        ...
        soundPool.play(introSound, 1, 1, 0, 0, 1);
        Intent intent = new Intent(RespondingQueriesActivity.this, MotivatedVoiceActivity.class );
        intent.putExtra(DivisionActivity.EXTRA_CHOOSE, choose);
        intent.putExtra(SurveyActivity.EXTRA_NAME, text_name);
        intent.putExtra(SurveyActivity.EXTRA_POSITION, text_position);
        intent.putExtra(SurveyActivity.EXTRA_PURPOSE, text_purpose);
...
//                    public void onClick(DialogInterface dialog, int which) {
//                        soundPool.play(introSound, 1, 1, 0, 0, 1);
//                        Intent intent = new Intent(RespondingQueriesActivity.this, DashboardActivity.class);
//                        startActivity(intent);
//                    }
//                })
//

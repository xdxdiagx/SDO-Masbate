...
public class OfficesCleanActivity extends AppCompatActivity implements SmileRating.OnSmileySelectionListener, SmileRating.OnRatingSelectedListener {

    public static final String EXTRA_RATING_OFFICES_CLEAN = "offices_clean";
    public static final String EXTRA_REMARKS_OFFICES_CLEAN = "offices_clean_remarks";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_offices_clean);
...
//        purpose.setText(text_purpose);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(rating == "None"){
                    ...
                    Intent intent = new Intent(OfficesCleanActivity.this, LastQuestionaireActivity.class );
                    ...
                    intent.putExtra(MotivatedVoiceActivity.EXTRA_RATING_MOTIVATED_VOICE, text_rating_MV);
                    intent.putExtra(MotivatedVoiceActivity.EXTRA_REMARKS_MOTIVATED_VOICE, text_remarks_MV);
                    intent.putExtra(RespondingQueriesActivity.EXTRA_RATING_RESPONDING_TO_QUERIES, text_rating_RQ);
                    intent.putExtra(RespondingQueriesActivity.EXTRA_REMARKS_RESPONDING_TO_QUERIES, text_remarks_RQ);
                    intent.putExtra(SmilingActivity.EXTRA_RATING_SMILING, text_rating_smiling);
                    intent.putExtra(SmilingActivity.EXTRA_REMARKS_SMILING, text_remarks_smiling);
                    intent.putExtra(ProvidingSolutionsActivity.EXTRA_RATING_PROVIDING_SOLUTIONS, text_rating_PS);
                    intent.putExtra(ProvidingSolutionsActivity.EXTRA_REMARKS_PROVIDING_SOLUTIONS, text_remarks_PS);
                    intent.putExtra(WastingNoTimeActivity.EXTRA_RATING_WASTING_NO_TIME, text_rating_wasting_no_time);
                    intent.putExtra(WastingNoTimeActivity.EXTRA_REMARKS_WASTING_NO_TIME, text_remarks_wasting_no_time);
                    intent.putExtra(ComfortRoomsActivity.EXTRA_RATING_COMFORT_ROOMS, text_rating_comfort_rooms);
                    intent.putExtra(ComfortRoomsActivity.EXTRA_REMARKS_COMFORT_ROOMS, text_remarks_comfort_rooms);
                    intent.putExtra(GuardsActivity.EXTRA_RATING_GUARDS, text_rating_guards);
                    intent.putExtra(GuardsActivity.EXTRA_REMARKS_GUARDS, text_remarks_guards);
                    intent.putExtra(WaitingAreaActivity.EXTRA_RATING_WAITING_AREA, text_rating_waiting_area);
                    intent.putExtra(WaitingAreaActivity.EXTRA_REMARKS_WAITING_AREA, text_remarks_waiting_area);
                    intent.putExtra(EXTRA_RATING_OFFICES_CLEAN, rating);
                    intent.putExtra(EXTRA_REMARKS_OFFICES_CLEAN, suggestionInput);
    ...
    public void onBackPressed() {
        ...
        soundPool.play(introSound, 1, 1, 0, 0, 1);
        Intent intent = new Intent(OfficesCleanActivity.this, WaitingAreaActivity.class );
        intent.putExtra(DivisionActivity.EXTRA_CHOOSE, choose);
        intent.putExtra(SurveyActivity.EXTRA_NAME, text_name);
        intent.putExtra(SurveyActivity.EXTRA_POSITION, text_position);
        intent.putExtra(SurveyActivity.EXTRA_PURPOSE, text_purpose);
...
//                    public void onClick(DialogInterface dialog, int which) {
//                        soundPool.play(introSound, 1, 1, 0, 0, 1);
//                        Intent intent = new Intent(OfficesCleanActivity.this, DashboardActivity.class);
//                        startActivity(intent);
//                    }
//                })
//
